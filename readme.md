...
This repository contains the core implementation of **BoneWave**, a mmWave-based contactless bone-conduction sensing framework for flexible phone call quality enhancement. BoneWave captures speech-induced bone-conduction vibrations around the ear using mmWave radar and fuses them with noisy audio signals to enhance speech quality under challenging acoustic conditions.
